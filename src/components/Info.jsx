 ...
 function Info() {
  return (
    <div className="relative w-full h-[500px] flex items-center justify-center text-center">
      ...
      > <img src="/public/assets/3872cf531b67c6202c38dc53126a3cc49440d867.jpg" alt="xatolik" className="w-full h-[600px]"/> </div>
      ...
      <div className="relative max-w-4xl px-6 text-white">
        ...
        <div className="w-32 h-[2px] bg-white/60 mx-auto mb-4"></div>
