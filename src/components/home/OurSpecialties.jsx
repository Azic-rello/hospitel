    ...
    <div className="pt-[100px]">
      <div>
        <div className="m-auto">
          <h1 className="text-xl text-center text-[#159EEC]">Always Caring</h1>
          <h2 className="text-4xl text-[] text-center mt-3 font-bold font-serif">
            Our Specialties
          </h2>
        </div>

        <div className="grid grid-cols-4 gap-8 mt-20 items-center w-[80%] m-auto">
          {heart.map((i) => (
            <center className="grid gap-3 ">
              <h1>
                <svg
                  width="50"
                  height="44"
      ...
      <div className="pt-[140px]">
        <img
          className="w-full -z-20 opacity-25 absolute h-[80vh]"
          src="../../../public/assets/image.png"
          alt=""
        />

        <div className="flex p-[50px_100px] items-center">
          <div className="grid h-[200px] w-[50%]">
            <h1 className="text-2xl text-[#159EEC] font-bold font-serif">
              Book an Appointment
            </h1>
            <p className="w-[80%]">
          ...
          <div>
            <div className="w-full border-2 border-purple-500 bg-[#243173]">
              <div className="grid grid-cols-2">
                <input
                  placeholder="Name"
                  className="h-14 bg-transparent border border-blue-300 px-4 text-white outline-none placeholder:text-blue-200"
                />

                <select className="h-14 bg-transparent border border-blue-300 px-4 text-blue-200 outline-none">
              ...
              <textarea
                placeholder="Message"
                className="w-full h-32 bg-transparent border-t border-blue-300 px-4 py-3 text-white outline-none placeholder:text-blue-200"
              />

              <button className="w-full bg-blue-200 text-blue-900 py-4 font-semibold">
                SUBMIT
              </button>
            </div>
          </div>
